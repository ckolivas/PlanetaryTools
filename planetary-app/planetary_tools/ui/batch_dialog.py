...
class BatchDialog(QDialog):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        step_btns.addWidget(self._filter_combo)
        ...
        self._bit_depth.addItem("16-bit TIFF", 16)
    ...
    def _add_step(self) -> None:
        ...
        fdef = FILTERS[fid]
        self._steps.append(PipelineStep(filter_id=fid, params=dict(fdef.default_params)))
        self._refresh_step_list()
    ...
    def _edit_step(self) -> None:
        ...
        new_params = edit_filter_params(step.filter_id, step.params, is_grayscale=False, parent=self)
